...
function Unleash() {
  return (
    <div className="bg-[#c86cbc]">
      <div className="py-10 max-sm:p-5">
        <p className="text-white text-[80px] max-sm:text-[40px] text-center">Unleash Your Pets</p>
      ...
      <div className="lg:flex py-10 md:space-x-1">
        ...
        <div className="flex flex-col justify-center space-y-10 max-lg:items-center">
          <div className="bg-white sm:flex items-center p-10 rounded-3xl sm:space-x-10 w-[70%] hover:rotate-6 transition">
            <img src={u1} alt="img" className="h-24 max-sm:m-auto" />
            <div className="">
              <p className="text-4xl mb-3 max-sm:text-center max-sm:text-2xl">Connect</p>
              <p className="text-gray-500 text-xl max-sm:text-lg max-sm:text-center">
          ...
          <div className="bg-white sm:flex items-center p-10 rounded-3xl sm:space-x-10 w-[70%] hover:rotate-6 transition">
            <img src={u1} alt="img" className="h-24 max-sm:m-auto" />
            <div>
              <p className="text-4xl mb-3 max-sm:text-center max-sm:text-2xl">Explore</p>
              <p className="text-gray-500 text-xl max-sm:text-lg max-sm:text-center">
          ...
          <div className="bg-white sm:flex items-center p-10 rounded-3xl sm:space-x-10 w-[70%] hover:rotate-6 transition">
            <img src={u1} alt="img" className="h-24 max-sm:m-auto" />
            <div>
              <p className="text-4xl mb-3 max-sm:text-center max-sm:m-auto max-sm:text-2xl">Enjoy</p>
              <p className="text-gray-500 text-xl max-sm:text-lg max-sm:text-center">
